...
made per month.In case the sale done is less than 50000,then the sales man is
...
sales man per week is to be provided as input.Use tuples/list to store data of
salesmen.
